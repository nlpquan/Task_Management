...
- Create a new task_management database `create database task_management;`, make sure to match with the application.properties file. Then `use task_management;`
